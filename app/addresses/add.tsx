...
import { validateAddress, AddressInsert } from '@/services/address-service';
...
export default function AddAddressScreen() {
  ...
  const { addNewAddress, syncing } = useAddressStore();
  ...
  const handleChange = (field: keyof AddressInsert, value: string | boolean) => {
  ...
  const handleSubmit = async () => {
    ...
    const result = await addNewAddress(addressData);
    if (result) {
      router.back();
    }
  };
